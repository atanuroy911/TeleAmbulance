...
// import GFX from 'vanta/dist/vanta.clouds.min'
        ...
        <section className='text-center'>
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Tele Ambulance Project</h1>
                    {/* <h4>(Version 1.00)</h4> */}
                    <p class="max-w-2xl mb-6 font-light text-gray-800 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-800">Welcome to the beta version of the Tele-Ambulance Project </p>
